...
const Restaurant = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-sky-50/50 to-stone-100">
      <Header />
      ...
      <section className="relative h-96 bg-gradient-to-br from-slate-900 via-sky-950 to-national-green flex items-center justify-center text-white overflow-hidden pattern-institutional">
        ...
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-br from-slate-900/80 via-sky-950/60 to-national-green/70"></div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-stone-50 via-sky-50/30 to-stone-50">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center mb-12">
              <div>
                ...
                <div className="bg-sky-100 p-4 rounded-lg">
                  <h3 className="font-bold text-sky-800 mb-2">{t('restaurant.orders.title')}</h3>
                  <p className="text-sky-700 flex items-center mb-2">
                  ...
                  <p className="text-sm text-sky-600 mt-1">{t('restaurant.delivery.available')}</p>
                </div>
              </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <Card key={index} className="group hover:shadow-xl transition-shadow border-l-4 border-l-sky-500">
                    ...
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <span className="text-lg font-bold text-sky-600">{dish.price}</span>
                        </div>
            ...
            <div className="text-center mt-12 bg-gradient-to-r from-stone-50 to-sky-50/40 p-8 rounded-lg">
              <img 
                src="/lovable-uploads/07343eb9-7b5a-4c93-8b44-eb37c618a84d.png" 
                alt="Restaurant La Marraine" 
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="bg-sky-600 hover:bg-sky-700 text-white text-xl px-8 py-4">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-gradient-to-r from-stone-50 to-sky-50/40 p-8 rounded-lg">
