...
import { Building, Ruler, Palette, Eye, Camera, MapPin, Navigation, ExternalLink, Heart, Star, Crown, BookOpen, User, Calendar, GraduationCap, Award, Landmark, Maximize2 } from 'lucide-react';
...
const Monument = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-sky-50/60 to-stone-50">
      ...
      <section className="relative h-96 bg-gradient-to-br from-sky-400 via-sky-500 to-sky-900 flex items-center justify-center text-white overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-br from-sky-400/70 via-sky-500/50 to-sky-900/70"></div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-sky-100 via-sky-200 to-sky-300">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-sky-900 mb-4">{t('monument.location.title')}</h2>
              <p className="text-xl text-sky-800">{t('monument.location.description')}</p>
            </div>
                ...
                <Card className="p-8 bg-white/90 backdrop-blur-sm shadow-xl">
                  <div className="space-y-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold text-sky-900">{t('site.title')}</h3>
                        <p className="text-sky-700">Sangmélima, Cameroun</p>
                      </div>
                    </div>

                    <div className="bg-sky-50 p-6 rounded-lg">
                      <h4 className="text-lg font-semibold text-sky-900 mb-3">{t('monument.location.gps')}</h4>
                      <div className="space-y-2">
                        <div className="flex items-center space-x-2">
                          <Navigation className="w-4 h-4 text-sky-600" />
                          <span className="text-sky-800 font-mono">2°57'32"N 11°57'45"E</span>
                        </div>
                        <div className="flex items-center space-x-2">
                          <MapPin className="w-4 h-4 text-sky-600" />
                          <span className="text-sky-800">{t('contact.address.line1')}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <Button 
                        ...
                        className="w-full bg-gradient-to-r from-sky-600 to-sky-700 hover:from-sky-700 hover:to-sky-800 text-white shadow-lg"
                        size="lg"
                      >
      ...
      <section className="py-20 bg-gradient-to-r from-stone-50 via-sky-50/60 to-stone-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-sky-900 mb-8">{t('monument.intro.title')}</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                ...
                {/* Ornements décoratifs */}
                <div className="absolute -top-4 -right-4 w-24 h-24 bg-gradient-to-br from-sky-400 to-sky-500 rounded-full opacity-20"></div>
                <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-br from-sky-400 to-sky-500 rounded-full opacity-30"></div>
              </div>

              {/* Citation de l'architecte */}
              <div className="space-y-6">
                <Card className="p-8 bg-white/90 backdrop-blur-sm shadow-xl border-l-4 border-l-sky-500">
                  <div className="space-y-6">
                    <div className="flex items-center space-x-3 mb-6">
                      <div className="w-12 h-12 bg-gradient-to-br from-sky-500 to-sky-500 rounded-full flex items-center justify-center">
                        <Building className="w-6 h-6 text-white" />
                      </div>
                      <h3 className="text-2xl font-bold text-sky-900">{t('monument.architect.title')}</h3>
                    </div>

                    <div className="bg-sky-50 p-6 rounded-lg border-l-4 border-l-sky-500">
                      <blockquote className="text-sky-900 italic text-lg leading-relaxed">
                        "{t('monument.architect.quote')}"
                      </blockquote>
                      <cite className="text-sky-700 block mt-4 font-medium">
                    ...
                    <div className="mt-6">
                      <Dialog>
                        ...
                        <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
                          <DialogHeader>
                            <DialogTitle className="text-2xl font-bold text-sky-900 flex items-center">
                          ...
                          <div className="space-y-6">
                            {/* Informations personnelles */}
                            <Card className="p-6 bg-gradient-to-br from-sky-50 to-sky-50">
                              ...
                              <div className="space-y-3">
                                {architectBibliography.education.map((edu, index) => (
                                  <div key={index} className="bg-sky-50 p-4 rounded-lg">
                                    <div className="font-semibold text-sky-900">{edu.degree}</div>
                                    <div className="text-sky-700">{edu.institution}</div>
                                    <div className="text-sm text-sky-600">{edu.year}</div>
                                  </div>
                                ))}
                              </div>
                            </Card>
                            ...
                            <Card className="p-6">
                              ...
                              <div className="space-y-4">
                                {architectBibliography.career.map((career, index) => (
                                  <div key={index} className="border-l-4 border-l-sky-500 pl-4">
                                    <div className="font-semibold text-sky-900">{career.position}</div>
                                    <div className="text-sky-700 text-sm">{career.period}</div>
                                    <div className="text-gray-600 text-sm mt-1">{career.description}</div>
                                  </div>
                                ))}
                              </div>
                            ...
                            <Card className="p-6">
                              ...
                              <ul className="space-y-2">
                                {architectBibliography.projects.map((project, index) => (
                                  <li key={index} className="flex items-start">
                                    <Star className="w-4 h-4 text-sky-500 mr-2 mt-0.5 flex-shrink-0" />
                            ...
                            <Card className="p-6">
                              ...
                              <p className="text-gray-700 italic bg-sky-50 p-4 rounded-lg">
      ...
      <section className="relative py-20 bg-gradient-to-br from-sky-50/60 via-stone-50 to-sky-50/60 overflow-hidden">
        {/* Image de fond */}
        <div className="absolute inset-0 opacity-20">
          <img 
            ...
            className="w-full h-full object-cover"
          />
          <div className="absolute inset-0 bg-gradient-to-br from-sky-400/80 via-sky-500/60 to-sky-600/80"></div>
        </div>
        <div className="relative z-10 container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-sky-900 mb-16">DÉCOUVRIR LE PROJET</h2>
          
          <div className="max-w-4xl mx-auto">
            <Card className="overflow-hidden shadow-2xl border-2 border-sky-300">
              <div className="bg-gradient-to-br from-sky-600 to-sky-800 p-8 text-white text-center">
                ...
                <Button 
                  size="lg" 
                  className="bg-white text-sky-800 hover:bg-sky-50 shadow-xl"
              ...
              <CardContent className="p-8 bg-white">
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="text-center">
                    ...
                    <h4 className="font-bold text-sky-900 mb-2">Plans Architecturaux</h4>
                    <p className="text-sm text-sky-700">Dessins techniques détaillés</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-3">
                      <Palette className="w-6 h-6 text-sky-600" />
                    </div>
                    <h4 className="font-bold text-sky-900 mb-2">Conception Artistique</h4>
                    <p className="text-sm text-sky-700">Symbolisme et esthétique</p>
                  </div>
                  <div className="text-center">
                    <div className="w-12 h-12 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-3">
                      <Ruler className="w-6 h-6 text-sky-600" />
                    </div>
                    <h4 className="font-bold text-sky-900 mb-2">Spécifications</h4>
                    <p className="text-sm text-sky-700">Dimensions et matériaux</p>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-gradient-to-br from-stone-50 via-sky-50/60 to-stone-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-sky-900 mb-16">{t('monument.characteristics.title')}</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            {[
              ...
              {
                title: t('monument.characteristics.area.title'),
                value: t('monument.characteristics.area.value'),
                icon: <Maximize2 className="w-8 h-8" />,
                description: t('monument.characteristics.area.description'),
                color: "from-national-green to-sky-800"
              },
              {
                title: t('monument.characteristics.funding.title'),
                value: t('monument.characteristics.funding.value'),
                icon: <Landmark className="w-8 h-8" />,
                description: t('monument.characteristics.funding.description'),
              ...
              <Card key={index} className="group text-center p-6 hover:shadow-xl transition-all duration-300 bg-white">
                ...
                <h3 className="text-lg font-bold mb-2 text-sky-900">{feature.title}</h3>
      ...
      <section className="py-20 bg-gradient-to-br from-sky-50/60 via-stone-50 to-sky-50/60">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-sky-900 mb-8">{t('monument.vision.title')}</h2>
            <div className="bg-gradient-to-r from-white/80 to-white/90 p-8 rounded-lg">
              <blockquote className="text-xl italic text-sky-900 mb-6 leading-relaxed">
                "{t('monument.vision.quote')}"
              </blockquote>
              <cite className="text-lg font-semibold text-sky-800">
                {t('monument.architect.name')}
              </cite>
            </div>
          </div>
