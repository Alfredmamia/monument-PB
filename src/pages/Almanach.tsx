  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-sky-50/60 to-stone-50">
      ...
      <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-sky-950 to-national-green flex items-center justify-center text-white overflow-hidden pattern-institutional">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-sky-300/50 via-sky-400/40 to-sky-500/50"></div>
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          <Badge className="mb-4 bg-white/20 text-white border-white/30">
            Partenariats Stratégiques
          </Badge>
          <h1 className="text-5xl md:text-6xl font-bold mb-4 drop-shadow-2xl text-sky-900">Almanach</h1>
      ...
      <section className="py-20 bg-gradient-to-r from-stone-50 via-sky-50/60 to-stone-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-sky-900 mb-8">Nos Partenaires du Projet Monument Paul Biya</h2>
      ...
      <section className="py-20 bg-gradient-to-br from-sky-50/60 via-stone-50 to-sky-50/60">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-sky-900 mb-16">Partenaires Institutionnels</h2>
              ...
              <Card 
               ...
               >
                 <CardContent className="p-6 text-center">
                   <div className="bg-gradient-to-br from-sky-100 to-sky-100 p-4 rounded-lg mb-4 shadow-sm">
                     <img 
                       src={partner.logo} 
                       alt={partner.name}
                   ...
                   <div className="flex items-center justify-center gap-2 mb-2">
                     <div className="text-sky-600">{partner.icon}</div>
                     <Badge variant="outline" className="border-sky-300 text-sky-700">{partner.category}</Badge>
                   </div>
                   <h3 className="text-lg font-bold mb-2 text-sky-900">{partner.name}</h3>
                   ...
                   {partner.almanach && (
                     <div className="mt-3">
                       <button 
                         ...
                         className="bg-sky-600 hover:bg-sky-700 text-white px-3 py-2 rounded text-xs transition-colors"
                       >
      ...
      <section className="py-20 bg-gradient-to-br from-stone-50 via-sky-50/60 to-stone-50">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-sky-900 mb-16">Partenaires Techniques</h2>
      ...
      <section className="py-20 bg-gradient-to-br from-sky-50/60 via-stone-50 to-sky-50/60">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-sky-900 mb-16">Types de Partenariats</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <Card key={index} className="group text-center p-6 hover:shadow-lg transition-shadow bg-white/95 backdrop-blur-sm">
                ...
                <h3 className="text-lg font-bold mb-2 text-sky-900">{type.title}</h3>
      ...
      <section className="py-20 bg-gradient-to-br from-stone-50 via-sky-50/60 to-stone-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl font-bold text-sky-900 mb-8">Remerciements</h2>
            <div className="bg-white/90 backdrop-blur-sm p-8 rounded-lg shadow-xl">
              ...
              <cite className="text-lg font-semibold text-sky-900">L'équipe du Monument Paul Biya - Sangmélima</cite>
            </div>
          </div>
        </div>
      </section>

      {/* Section Almanachs Visualisables */}
      <section className="py-20 bg-gradient-to-br from-sky-50/60 via-stone-50 to-sky-50/60">
        <div className="container mx-auto px-4">
          <h2 className="text-4xl font-bold text-center text-sky-900 mb-16">Almanachs Disponibles pour Visualisation</h2>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                name: "CAMTEL",
                description: "Cameroun Télécommunications",
                pdfPath: "/almanachs/ALMANACH CAMTEL.pdf",
                logo: "/lovable-uploads/f5e82fac-7fa6-4f34-b61e-3057c20c531f.png",
                category: "Télécommunications"
              },
              {
                name: "CEBR",
                description: "Cabinet d'études et de réalisation",
                pdfPath: "/almanachs/ALMANACH CEBR.pdf",
                logo: "/lovable-uploads/f95a3ba7-5d16-4446-83a2-a195b008333c.png",
                category: "Architecture"
              },
              {
                name: "KP AFRICA",
                description: "Partenaire technique et logistique",
                pdfPath: "/almanachs/ALMANACH KP AFRICA.pdf",
                logo: "/lovable-uploads/6ffdb104-4794-4406-ad21-04b6931fa882.png",
                category: "Technique"
              },
              {
                name: "MINTOUL",
                description: "Ministère du Tourisme et des Loisirs",
                pdfPath: "/almanachs/ALMANACH MINTOUL.pdf",
                logo: "/lovable-uploads/01edca7f-ea9e-4ce1-b0b0-c687c13518e8.png",
                category: "Tourisme"
              },
              {
                ...
                pdfPath: "/almanachs/ALMANACH SONDY.pdf",
                logo: "/lovable-uploads/5d240f06-7ffe-4ae2-8ab2-6a7a6c4c56bc.png",
                category: "Technique"
              },
              {
                name: "MINFOF",
                description: "Ministère des Forêts et de la Faune",
                pdfPath: "/almanachs/ALMANACH MINFOF.pdf",
                logo: "/lovable-uploads/b5f2bd7e-d4a6-4425-b70d-b6e27162fe1d.png",
                category: "Environnement"
              }
            ].map((almanach, index) => (
              <Card key={index} className="group hover:shadow-xl transition-all duration-300 bg-white/95 backdrop-blur-sm">
                <CardContent className="p-6">
                  <div className="bg-gradient-to-br from-sky-100 to-sky-100 p-4 rounded-lg mb-4 shadow-sm text-center">
                    <img 
                      src={almanach.logo} 
                      alt={almanach.name}
                  ...
                  <h3 className="text-lg font-bold mb-2 text-sky-900 text-center">{almanach.name}</h3>
                  <p className="text-gray-600 text-sm text-center mb-4">{almanach.description}</p>
                  
                  {/* Viewer PDF intégré */}
                  <div className="border border-sky-200 rounded-lg overflow-hidden bg-white">
                    <iframe
                      src={almanach.pdfPath}
                      width="100%"
                      height="300"
                      className="border-0"
                      title={`Almanach ${almanach.name}`}
                    />
                  </div>
                  
                  <div className="flex gap-2 mt-4">
                    <button 
                      onClick={() => window.open(almanach.pdfPath, '_blank')}
                      className="flex-1 bg-sky-600 hover:bg-sky-700 text-white px-3 py-2 rounded text-sm transition-colors"
                    >
                    ...
                    <button 
                      onClick={() => {
                        ...
                        link.href = almanach.pdfPath;
                        link.download = `ALMANACH_${almanach.name.replace(/\s+/g, '_')}.pdf`;
                        link.click();
                      }}
          ...
          <div className="text-center mt-12">
            <div className="bg-white/90 backdrop-blur-sm p-6 rounded-lg shadow-lg inline-block">
              <p className="text-sky-800 font-medium">
                📖 Consultez directement les almanachs de nos partenaires ci-dessus
              </p>
              <p className="text-sky-600 text-sm mt-2">
                Cliquez sur "Ouvrir en plein écran" pour une meilleure visualisation ou "Télécharger" pour sauvegarder
              </p>
            </div>
          </div>
        </div>
