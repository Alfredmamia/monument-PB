                    ...
                    <div>
                      ...
                      <div className="space-y-3">
                        <div className="bg-blue-50 p-3 rounded-lg">
                          <div className="font-medium text-blue-800">Soutien Scolaire</div>
                          <div className="text-sm text-blue-600">Aide aux devoirs et préparation aux examens</div>
                        </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className="group hover:shadow-lg transition-shadow bg-white/90 backdrop-blur-sm">
                <CardContent className="p-6">
                  <div className="w-16 h-16 bg-gradient-to-br from-sky-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform">
